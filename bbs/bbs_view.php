...
?>
    ...
    {?>  
        <div class='row'>
        <div class="col-sm-1 offset-sm-10"><a class='btn btn-primary btn-sm' href='./bbs_modify.php?no=<?php echo $bbs_no;?>'>수정하기</a></div>
        <div class="col"><a class='btn btn-primary btn-sm' href='./bbs_delete.php?no=<?php echo $bbs_no;?>'>삭제하기</a></div>
        </div>
<?php } ?>
<hr>
<!-- 댓글 기능페이지 불러오기 -->
