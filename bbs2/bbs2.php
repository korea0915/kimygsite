...
<!-- bbs2게시판 페이지 -->
  ...
  <?php 
        ...
        { 
          ...
          /* Get방식으로 게시판 번호를 참조해서 링크 */                                                                                         /* 댓글 수 표시 */
          echo "<td><a href='bbs2_view.php?no={$v['no']}' style='color:black;'>{$limited_title} <span class='badge rounded-pill bg-secondary'>$c_comment</span></a></td>";
      ...
      <div class="row">
        ...
        <?php
          if(isset($_SESSION['user_id'])){
            echo "<div class='col-md-1 offset-md-3'><a class='bbtn btn-primary btn-sm' href='./bbs2_write.php'>글 쓰기</a></div>";
          }
        ?>
    </div>
  </div>
  ...
  <div class="container">
      <!-- 검색할 내용 get방식으로 값 전달 -->
      <form class="row g-3" method="get" action="./bbs2_search.php">
        <!-- 어떤기준으로 검색할지 선택 -->
        <div class="col-auto">
